...
import { Mountain, Instagram, Facebook, Youtube, Bike, Clock, Users, MapPin, Sparkles } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white">
      <main>
        ...
        {/* Seção de vitrine integrada mantendo o layout original limpo */}
              ...
              {passeiosFiltrados.map((passeio) => (
                <div key={passeio.id} className="bg-neutral-900 rounded-sm border border-neutral-800 overflow-hidden shadow-sm hover:border-neutral-700 transition flex flex-col">
                  ...
                  <div className="p-5 flex-1 flex flex-col justify-between">
                    <div>
                      <h3 className="text-lg font-bold text-white mb-1 line-clamp-2">{passeio.title}</h3>
                      {passeio.location && (
